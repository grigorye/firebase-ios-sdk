...
/// Gets an existing `FIRHeartbeatLogger` instance with the given `appID` if one exists. Otherwise,
/// makes a new instance with the given `appID`.
///
/// @param appID The app ID that the logger corresponds to.
